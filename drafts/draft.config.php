<?php return array
	(
		...
		// is the application using a production database?
		'db:lock' => true, 
			# true  = migrations will only allow safe operations 
			# false = migration operations that result in data loss are allowed
		...
		// web console access; requires overlord to be included
		'overlord' => array
			(
